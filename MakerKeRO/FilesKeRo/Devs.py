...
async def welcome(client: Client, message):
   try:
    ...
    if message.new_chat_members[0].username == "Q_K_Q_Q":
      try:
        ...
        pass
      return await message.reply_text(f"**♪ انضم المطور ساو للشات  💎 .\n♪ مرحبا بك : @Y_J_J_J  💎 .**")
...
**"""
      ...
      pass        
#//=================================EDITED BY Https://t.me/Y_J_J_J ========================================//
@Client.on_message(filters.command(["المطور ساو"], ""))
async def deev(client: Client, message: Message):
     if await joinch(message):
            return
     user = await client.get_chat(chat_id="Q_K_Q_Q")
