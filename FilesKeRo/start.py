...
bot = [
  ...
  "اخوي شغال شغال",
  "احبك كول شنو تريد",
  "حبي كول شتريد لتكفرنه راح امشي ",
  "قلب {} من جوه",
  "نعم حبي {} ",
  "لعبت نفسي والله بس احبك شسوي امري لله",
  "خلاص حجينه وضحكنا كول شتريد ؟",
  "كول يقلبو ",
  "ؤيب بذمتك لو انت بوت ترضا احد يكفرك هيج؟",
]
...
async def keroooo(client: Client, message: Message):
    ...
    await client.send_photo(message.chat.id,url,caption="**♪ 𝙾𝚆𝙽𝙴𝚁 ➧ @Q_K_Q_Q  💎 .**",
    reply_markup=InlineKeyboardMarkup(
            [
                [
