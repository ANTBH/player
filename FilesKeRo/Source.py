...
async def alive(client: Client, message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            ...
            [ 
                 InlineKeyboardButton("اضف البوت الئ مجموعتك سورس ساو العراقي", url="https://t.me/{app.username}?startgroup=true")
            ]
        ]
    )

    alive = f"""╭──── • ◈ • ────╮
么 [𝙾𝚆𝙽𝙴𝚁1](t.me/Q_K_Q_Q) 💎 .
么 [𝑪𝒉𝒂𝒏𝒏𝒆𝒍 𝒔𝒐𝒖𝒓𝒄𝒆](t.me/botat_0).
╰──── • ◈ • ────╯
